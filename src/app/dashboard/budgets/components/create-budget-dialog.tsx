...
export function CreateBudgetDialog() {
  const { createBudgetOpen, CloseCreateBudgetDialog } = useDialogStore();
  ...
  return (
    <Dialog open={createBudgetOpen} onOpenChange={CloseCreateBudgetDialog}>
            ...
            <Field>
              ...
              <Select>
                <SelectTrigger className="w-full">
                  <SelectValue placeholder="Choose a category" className="" />
                  <ChevronDownIcon />
                </SelectTrigger>
